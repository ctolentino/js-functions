...
//best practice = use a semicolon after each *instruction*
...
console.log("subtract function", difference);
...
console.log("divide function", quotient);
...
console.log("checkproduct function", checkProduct());
...
console.log("checkquotient function", checkQuotient());
...
function addThenSubtract(num1, num2, num3){
	...
	console.log("sum", sum);
	var difference = subtract(num3, sum);
	console.log("diff", difference);
	return difference;
}

console.log("addthensubtractfunction", addThenSubtract(bango3, bango4, bango5));
...
var firstName = "bob";
var lastName = "weouttababyitsaboy";
...
return myFullName + " eats Won Ton Soup everyday for breakfast."	
}
...
var convertintocm = shoeSize(bango1);

console.log("convertintocm", convertintocm);
/*
 * #15
 * Function allCaps
...
var sentence = "I am enthusiastic."; 

function allCaps(str){	
	//return str.toUpperCase();
}

var capSentence = allCaps();

//console.log("capSentence", capSentence);
...
var canDrink = verifyDrinkingAge(bango5);
...
//why no ; after if else statements?
